                      ...
                      children: [
                        ...
                        (0, o.jsxs)("ul", {
                          ...
                          children: [
                            ...
                            (0, o.jsx)("li", {
                              children:
                                'Each license key can be used on 5 devices which is typically enough for 1 user. If you need to use it on for more devices, you can buy a new license keys or add more devices to your existing license key. "Device" is counted based on the number of places where the license key is entered and the chat history is saved for continuous use. For example, if you use Typing Mind on Chrome browser on your laptop and also on your phone, that will be 2 devices. Note that the license key is saved per browser, so if you use Typing Mind on Chrome and also on Firefox, you will need to enter the license key 2 times, have 2 separate chat history storage, and that counts as 2 devices. If you need to use the license key on a new device but have reached the limit, you can unlink the previous device first using the License Manager. This device limit is put in place to avoid license key abuse and pirate.',
                            }),
                            (0, o.jsx)("li", {
                              children:
                          ...
                          children: [
                            ...
                            (0, o.jsxs)("li", {
                              children: [
                                ...
                                " ",
                                "for them). Note that they will also need to enter an OpenAI API Key before using the app. Typing Mind is a static web app and have no backend, so you cannot bundle the OpenAI API key into the app securely.",
                              ],
                            }),
                            (0, o.jsxs)("li", {
                              children: [
